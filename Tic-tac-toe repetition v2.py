...
# Note: V2 removed unnecessary code from player_input function (number input) as it was missinterperated from the assignment, also removed some code in the while statement that runs the functions
...
while True:
    ...
    # returns player1shape and player2shape
    player1_shape, player2_shape = player_input() 
    
    
    print(f"Player {int_random_player_start} starts first!")
    ...
    if not replay():
        break
        # Denna befinner sig i första while loopen, om denna blir false så bryter den ut ur den, om inte så startar första loopen        
